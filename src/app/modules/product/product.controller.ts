...
const createProduct = catchAsync(async (req: Request, res: Response) => {
	const result = await ProductService.createProduct(req.body, req.files as IImageFiles, req.user as IJwtPayload);
...
const deleteProduct = catchAsync(async (req, res) => {
	...
	const result = await ProductService.deleteProduct(productId, user as IJwtPayload);
